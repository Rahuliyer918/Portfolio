...
import developerAnimation from '../assets/hero.json';

const Hero = () => {
  return (
    <section id='hero' className="pt-20 bg-gradient-to-b from-[#0f0f1a] to-[#1a1a2e] text-teal-100 min-h-screen flex flex-col md:flex-row items-center justify-center text-left p-8 gap-10">
      <div className="flex-1">
        <h1 className="text-5xl sm:text-6xl font-bold mb-4">Hi, I'm Rahulnarayan,</h1>
        <p className="mt-3 text-left text-lg max-w-4xl leading-[30px] mb-6">
